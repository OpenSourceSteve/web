export const NumberInput = ({name, label, changeHandler, state}) => {
    return (
        <div className="relative">
            <input type="number"
                className="peer h-10 w-full border-b-2 border-gray-400 text-gray-900 placeholder-transparent focus:outline-none focus:border-slate-600"
                id={name}
                name={name}
                value={state[name]}
