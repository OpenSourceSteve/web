...
export default function LawyerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBarAssociation(initialValues.barAssociation);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Lawyer(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LawyerCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
